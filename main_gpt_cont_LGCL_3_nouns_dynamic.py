...
#         self.sched = get_linear_schedule_with_warmup(self.optim,num_warmup_steps=0,num_training_steps=total_steps)
    ...
    def valid_one_epoch(self,epoch):
        ...
        return val_pxp, val_loss, average_accuracy, average_bleus
    ...
    def fit(self, task_num, task_name):
        ...
        for epoch in prog:
            ...
            pxp, loss, average_accuracy, average_bleus = self.valid_one_epoch(epoch)
            self.clean()
            ...
            if pxp < best_pxp:
                ...
                with open('training_output.csv', 'a') as file:
                    ...
                    file.write(f'{pxp},{loss},{average_accuracy},{average_bleus},{task},{timestamp}\n')

            # print(f"for epoch {epoch} current_task_pool {self.current_task_pool}")

        # print(f"current_task_pool {self.current_task_pool}")
        # print(f"neg_prompt_pool {self.neg_prompt_pool}")
